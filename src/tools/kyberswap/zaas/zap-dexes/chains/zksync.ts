...
export const ZKSYNC_ZAP_DEXES: ChainZapDexConfig = {
  ...
  dexes: [
    ...
    { id: "DEX_KOICL", name: "KOI CL", supports: [...ALL_OPS], verification: "verified" },
    { id: "DEX_KOILEGACY", name: "KOI Legacy", supports: [...ALL_OPS], verification: "verified" },
    { id: "DEX_SYNCSWAP_V3", name: "SyncSwap V3", supports: [...ALL_OPS], verification: "verified" },
    { id: "DEX_ZKSWAP_V2", name: "ZkSwap V2", supports: [...ALL_OPS], verification: "verified" },
