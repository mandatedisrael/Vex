...
export const ARBITRUM_ZAP_DEXES: ChainZapDexConfig = {
  ...
  dexes: [
    ...
    { id: "DEX_CAMELOTV3", name: "Camelot V3", supports: [...ALL_OPS], verification: "verified", ...NFT_CL, positionManagerAddress: getNfpm(C, "DEX_CAMELOTV3"), dexscreenerIds: ["camelot"] },
    { id: "DEX_RAMSESCL", name: "Ramses CL", supports: [...ALL_OPS], verification: "verified", ...NFT_CL, positionManagerAddress: getNfpm(C, "DEX_RAMSESCL"), dexscreenerIds: ["ramses"] },
    // SwapMode V3/V2 removed — only deployed on Mode Network, not Arbitrum
