...
export const ARBITRUM_ZAP_DEXES: ChainZapDexConfig = {
  chain: "arbitrum",
  ...
  dexes: [
    ...
    { id: "DEX_CAMELOTV3", name: "Camelot V3", supports: [...ALL_OPS], verification: "verified", ...NFT_CL, dexscreenerIds: ["camelot"] },
    { id: "DEX_RAMSESCL", name: "Ramses CL", supports: [...ALL_OPS], verification: "verified", ...NFT_CL, dexscreenerIds: ["ramses"] },
    { id: "DEX_SWAPMODEV3", name: "SwapMode V3", supports: [...ALL_OPS], verification: "verified", ...NFT_CL },
    { id: "DEX_SWAPMODEV2", name: "SwapMode V2", supports: [...ALL_OPS], verification: "verified", ...V2_BASIC },
