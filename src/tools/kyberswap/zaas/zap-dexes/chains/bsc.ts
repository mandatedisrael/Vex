...
export const BSC_ZAP_DEXES: ChainZapDexConfig = {
  ...
  dexes: [
    ...
    { id: "DEX_THENAALGEBRAINTEGRAL", name: "Thena Algebra Integral", supports: [...ALL_OPS], verification: "verified", ...NFT_CL, positionManagerAddress: getNfpm(C, "DEX_THENAALGEBRAINTEGRAL") },
