...
export const BSC_ZAP_DEXES: ChainZapDexConfig = {
  chain: "bsc", lastVerified: "2026-04-03", source: "KyberSwap ZaaS docs",
  dexes: [
    { id: "DEX_UNISWAPV3", name: "Uniswap V3", supports: [...ALL_OPS], verification: "verified", ...NFT_CL },
    ...
    { id: "DEX_THENAFUSION", name: "Thena Fusion", supports: [...ALL_OPS], verification: "verified", ...VAULT_SHARE },
    { id: "DEX_THENAALGEBRAINTEGRAL", name: "Thena Algebra Integral", supports: [...ALL_OPS], verification: "verified", ...NFT_CL },
