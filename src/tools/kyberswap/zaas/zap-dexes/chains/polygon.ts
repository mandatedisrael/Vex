...
export const POLYGON_ZAP_DEXES: ChainZapDexConfig = {
  ...
  dexes: [
    ...
    { id: "DEX_SUSHISWAPV3", name: "SushiSwap V3", supports: [...ALL_OPS], verification: "verified", ...NFT_CL, positionManagerAddress: getNfpm(C, "DEX_SUSHISWAPV3"), dexscreenerIds: ["sushiswap"], dexscreenerLabels: ["v3"] },
    { id: "DEX_SUSHISWAPV2", name: "SushiSwap V2", supports: [...ALL_OPS], verification: "verified", ...V2_BASIC, dexscreenerIds: ["sushiswap"], dexscreenerLabels: ["v2"] },
    { id: "DEX_QUICKSWAPV3ALGEBRA", name: "QuickSwap V3 (Algebra)", supports: [...ALL_OPS], verification: "verified", ...NFT_CL, positionManagerAddress: getNfpm(C, "DEX_QUICKSWAPV3ALGEBRA"), dexscreenerIds: ["quickswap"], dexscreenerLabels: ["v3"] },
    { id: "DEX_QUICKSWAPV2", name: "QuickSwap V2", supports: [...ALL_OPS], verification: "verified", ...V2_BASIC, dexscreenerIds: ["quickswap"], dexscreenerLabels: ["v2"] },
    { id: "DEX_GAMMA", name: "Gamma", supports: [...ALL_OPS], verification: "verified", ...VAULT_SHARE },
    { id: "DEX_STEER", name: "Steer", supports: [...ALL_OPS], verification: "verified", ...VAULT_SHARE },
