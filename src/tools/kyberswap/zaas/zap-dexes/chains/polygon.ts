...
export const POLYGON_ZAP_DEXES: ChainZapDexConfig = {
  ...
  dexes: [
    ...
    { id: "DEX_SUSHISWAPV3", name: "SushiSwap V3", supports: [...ALL_OPS], verification: "verified", ...NFT_CL, dexscreenerIds: ["sushiswap"], dexscreenerLabels: ["v3"] },
    ...
    { id: "DEX_QUICKSWAPV3ALGEBRA", name: "QuickSwap V3 (Algebra)", supports: [...ALL_OPS], verification: "verified", ...NFT_CL, dexscreenerIds: ["quickswap"], dexscreenerLabels: ["v3"] },
