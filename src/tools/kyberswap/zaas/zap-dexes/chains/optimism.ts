...
export const OPTIMISM_ZAP_DEXES: ChainZapDexConfig = {
  chain: "optimism", lastVerified: "2026-04-03", source: "KyberSwap ZaaS docs",
  dexes: [
    ...
    { id: "DEX_VELODROME_SLIPSTREAM", name: "Velodrome Slipstream", supports: [...ALL_OPS], verification: "verified", ...NFT_CL },
