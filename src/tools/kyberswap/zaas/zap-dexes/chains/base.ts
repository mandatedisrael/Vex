...
export const BASE_ZAP_DEXES: ChainZapDexConfig = {
  ...
  dexes: [
    ...
    { id: "DEX_AERODROMECL", name: "Aerodrome CL", supports: [...ALL_OPS], verification: "verified", ...NFT_CL, dexscreenerIds: ["aerodrome"] },
    ...
    { id: "DEX_ZKSWAP_V3", name: "ZkSwap V3", supports: [...ALL_OPS], verification: "verified", ...NFT_CL },
